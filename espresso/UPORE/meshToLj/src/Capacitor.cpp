...
capacitor::capacitor(electrode* electrodes, int num_electrodes)
{
    ...
    std::string fname = "C:/Users/Konrad/Documents/CodeBlocksProjects/meshToLJ/meshToLj/surfaceGrid.txt";
    ...
    for (int i = 0; i < num_electrodes; i++)
    {
        ...
        fname = "C:/Users/Konrad/Documents/CodeBlocksProjects/meshToLJ/meshToLj/distVolumeGrid" + intToString(i) + ".txt";
    ...
    potVolumeGridFile.open ("C:/Users/Konrad/Documents/CodeBlocksProjects/meshToLJ/meshToLj/potVolumeGrid.txt");
    int cnt = 0;
    for (int x = 0; x < _bins[0]; x++)
    {
        for (int y = 0; y < _bins[1]; y++)
