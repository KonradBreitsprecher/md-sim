...
set path "/lustre/ws1/ws/esbw0686-data-0/BMIMPF6/${run_ident}"
...
#set vtf_file [open "$path/trajectory/trajectory_${charge_dens}.vtf" "w"]
...
puts $out "Total MDtime:     [setmd time]"
close $out
