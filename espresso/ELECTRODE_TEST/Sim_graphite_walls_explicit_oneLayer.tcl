...
set nLeftWallParticles [setmd n_part]
...
set nRightWallParticles [setmd n_part]
...
for {set i 0} { $i < $nLeftWallParticles} {incr i} {
	part $i q [expr $charge_dens*$electrode_area/$nLeftWallParticles]
}

for {set j $i} { $j < $nRightWallParticles} {incr j} {
	part $j q [expr -$charge_dens*$electrode_area/$nLeftWallParticles]
}


puts [inter coulomb $l_b p3m tunev2 accuracy 1e-2]i
