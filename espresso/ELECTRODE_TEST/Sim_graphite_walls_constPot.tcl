...
set obs_orientation [observable new molecule_orientation ids $oriList minx 0 maxx $box_h xbins 1 miny 0 maxy $box_h ybins 1 minz 0 maxz $obs_range zbins $nbins]
set obs_anion_pos_id [observable new density_profile type [list $a_type] minx 0 maxx $box_h xbins 1 miny 0 maxy $box_h ybins 1 minz 0 maxz $obs_range zbins $nbins]
set obs_cation_pos_id [observable new density_profile type [list $non_virtual_type] minx 0 maxx $box_h xbins 1 miny 0 maxy $box_h ybins 1 minz 0 maxz $obs_range zbins $nbins]
set obs_cation_c1_id [observable new density_profile type [list $c1_type] minx 0 maxx $box_h xbins 1 maxy $box_h ybins 1 minz 0 maxz $obs_range zbins $nbins]
set obs_cation_c2_id [observable new density_profile type [list $c2_type] minx 0 maxx $box_h xbins 1 maxy $box_h ybins 1 minz 0 maxz $obs_range zbins $nbins]
set obs_cation_c3_id [observable new density_profile type [list $c3_type] minx 0 maxx $box_h xbins 1 maxy $box_h ybins 1 minz 0 maxz $obs_range zbins $nbins]
...
for {set j 0} {$j < $nbins} {incr j} { 
	lappend zlist [expr 1.0*$obs_range/$nbins*$j]
}
