...
proc temp_il {} {
	...
	foreach ion $cationComlist { 
		set kin_energy [expr $kin_energy + $m_bmim*[veclensqr [part $ion print v]] + 646.284*pow([lindex [part $ion print omega_body] 0],2) + 585.158*pow([lindex [part $ion print omega_body] 1],2) + 61.126*pow([lindex [part $ion print omega_body] 2],2)]
	}
	set temp_c [expr 0.5*$kin_energy/((6.0/2.0)*[llength $cationComlist])/$kb_kjmol]
