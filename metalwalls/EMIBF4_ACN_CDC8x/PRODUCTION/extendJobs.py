...
for subdir, dirs, files in os.walk(rootdir):
	if len(dirs) == 0:
		...
		#runtimeData[-52] = ".true.      constant potential? (if .false. then constant charge)\n"
		#runtimeData[-57] = ".true.      constant potential? (if .false. then constant charge)\n"
		#runtimeData[-51] = "-0.0368      wall potential (if previous line .false. then this is the charge)\n"
		#runtimeData[-56] = "0.0368       wall potential (if previous line .false. then this is the charge)\n"

		#runtimeData.insert(-45,"5.0d-7   wall convergence parameter\n")
		#del runtimeData[-45]
		#runtimeData[-10] = "10\n"
		...
		print "INPUTDIR=" + ap
		print "JOB=\"" + job + "\""                                                           
		print "mkdir -p $HOME/data/PRODUCTION/$JOB"
		print "cd $HOME/data/PRODUCTION/$JOB"
