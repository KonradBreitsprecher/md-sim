...
dr10.'surface_density.out6' ev :::0::0 u (($1+10.39)/1.8897-2.749):($2*6.7483345) w lp ls 13 lw 5 t 'Cathode - ACN $10 \%$ ACN 1V',\
dr20.'surface_density.out6' ev :::0::0 u (($1+10.39)/1.8897-2.749):($2*6.7483345) w lp ls 14 lw 5 t 'Cathode - ACN $20 \%$ ACN 1V',\
dr40.'surface_density.out6' ev :::0::0 u (($1+10.39)/1.8897-2.749):($2*6.7483345) w lp ls 15 lw 5 t 'Cathode - ACN $40 \%$ ACN 1V',\
dr67.'surface_density.out6' ev :::0::0 u (($1+10.39)/1.8897-2.749):($2*6.7483345) w lp ls 16 lw 5 t 'Cathode - ACN $67 \%$ ACN 1V'
