...
dr0.'surface_density.out1'  ev :::0::0 u (($1+10.39)/1.8897-2.749):($2*6.7483345) w lp ls 12 lw 5 t 'Cathode - BF4 $0 \%$ ACN 1V',\
dr10.'surface_density.out1' ev :::0::0 u (($1+10.39)/1.8897-2.749):($2*6.7483345) w lp ls 13 lw 5 t 'Cathode - BF4 $10 \%$ ACN 1V',\
dr20.'surface_density.out1' ev :::0::0 u (($1+10.39)/1.8897-2.749):($2*6.7483345) w lp ls 14 lw 5 t 'Cathode - BF4 $20 \%$ ACN 1V',\
dr40.'surface_density.out1' ev :::0::0 u (($1+10.39)/1.8897-2.749):($2*6.7483345) w lp ls 15 lw 5 t 'Cathode - BF4 $40 \%$ ACN 1V',\
dr67.'surface_density.out1' ev :::0::0 u (($1+10.39)/1.8897-2.749):($2*6.7483345) w lp ls 16 lw 5 t 'Cathode - BF4 $67 \%$ ACN 1V'
