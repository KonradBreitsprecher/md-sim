...
p \
dr10.'surface_density.out6' ev :::0::0 u (($1+10.39)/1.8897-2.749):($2*6.7483345) w lp ls 2 lw 5 t 'Cathode - ACN $10 \%$ ACN 1V',\
dr20.'surface_density.out6' ev :::0::0 u (($1+10.39)/1.8897-2.749):($2*6.7483345) w lp ls 3 lw 5 t 'Cathode - ACN $20 \%$ ACN 1V',\
dr40.'surface_density.out6' ev :::0::0 u (($1+10.39)/1.8897-2.749):($2*6.7483345) w lp ls 4 lw 5 t 'Cathode - ACN $40 \%$ ACN 1V',\
dr67.'surface_density.out6' ev :::0::0 u (($1+10.39)/1.8897-2.749):($2*6.7483345) w lp ls 5 lw 5 t 'Cathode - ACN $67 \%$ ACN 1V'
