...
p \
dl0.'surface_density.out2'  ev :::0::0 u (($1+10.39)/1.8897-2.749):($2*6.7483345) w lp ls 1 lw 5 t 'Anode - EMIM $0 \%$ ACN 1V',\
dl10.'surface_density.out2' ev :::0::0 u (($1+10.39)/1.8897-2.749):($2*6.7483345) w lp ls 2 lw 5 t 'Anode - EMIM $10 \%$ ACN 1V',\
dl20.'surface_density.out2' ev :::0::0 u (($1+10.39)/1.8897-2.749):($2*6.7483345) w lp ls 3 lw 5 t 'Anode - EMIM $20 \%$ ACN 1V',\
dl40.'surface_density.out2' ev :::0::0 u (($1+10.39)/1.8897-2.749):($2*6.7483345) w lp ls 4 lw 5 t 'Anode - EMIM $40 \%$ ACN 1V',\
dl67.'surface_density.out2' ev :::0::0 u (($1+10.39)/1.8897-2.749):($2*6.7483345) w lp ls 5 lw 5 t 'Anode - EMIM $67 \%$ ACN 1V'
