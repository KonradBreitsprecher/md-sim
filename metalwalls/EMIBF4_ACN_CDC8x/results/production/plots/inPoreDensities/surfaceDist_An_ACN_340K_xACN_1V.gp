...
p \
dl10.'surface_density.out7' u (($1+10.39)/1.8897):2 w lp t 'Anode - C 340K 10ACN 1V',\
dl20.'surface_density.out7' u (($1+10.39)/1.8897):2 w lp t 'Anode - C 340K 20ACN 1V',\
dl40.'surface_density.out7' u (($1+10.39)/1.8897):2 w lp t 'Anode - C 340K 40ACN 1V'
