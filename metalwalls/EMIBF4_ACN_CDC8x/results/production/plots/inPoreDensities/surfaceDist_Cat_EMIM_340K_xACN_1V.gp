...
p \
dr0.'surface_density.out2' u  (($1+10.39)/1.8897):($2*6.7483345) w lp t 'Cathode - Imidazole 340K 0ACN 1V',\
dr10.'surface_density.out2' u (($1+10.39)/1.8897):($2*6.7483345) w lp t 'Cathode - Imidazole 340K 10ACN 1V',\
dr20.'surface_density.out2' u (($1+10.39)/1.8897):($2*6.7483345) w lp t 'Cathode - Imidazole 340K 20ACN 1V',\
dr40.'surface_density.out2' u (($1+10.39)/1.8897):($2*6.7483345) w lp t 'Cathode - Imidazole 340K 40ACN 1V'
