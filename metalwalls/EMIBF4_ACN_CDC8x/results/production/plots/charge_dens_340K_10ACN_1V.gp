...
set obj rect from 11, graph 0 to graph 1, graph 1
...
p \
'~/git/md-sim/metalwalls/EMIBF4_ACN_CDC8x/results/production/data/AV_340K_10ACN_1V/av_density.out' u ($1/18.897):(($3*-0.78+$4*0.3591+$5*0.1888+$6*0.2321+$7*-0.398+$8*0.129+$9*0.269)*6748.3345) w lp ls 1 lw 2  lc rgb'#00a092' ps 0.5 t '$\mathrm{10 \% \ Acetonitrile \ 1V}$'
