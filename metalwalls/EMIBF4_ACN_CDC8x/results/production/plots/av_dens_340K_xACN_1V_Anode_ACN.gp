...
set title 'Anode ACN Density'

p \
d10.'av_density.out' u ($1/18.897):(($7*14.01+$8*12.01+$9*15.04)*11205.87) w lp ls 2 lw 2 ps 0.5 t '$\mathrm{10 \% \ Acetonitrile \ 1V}$',\
d20.'av_density.out' u ($1/18.897):(($7*14.01+$8*12.01+$9*15.04)*11205.87) w lp ls 3 lw 2 ps 0.5 t '$\mathrm{20 \% \ Acetonitrile \ 1V}$',\
d40.'av_density.out' u ($1/18.897):(($7*14.01+$8*12.01+$9*15.04)*11205.87) w lp ls 4 lw 2 ps 0.5 t '$\mathrm{40 \% \ Acetonitrile \ 1V}$',\
d67.'av_density.out' u ($1/18.897):(($7*14.01+$8*12.01+$9*15.04)*11205.87) w lp ls 5 lw 2 ps 0.5 t '$\mathrm{67 \% \ Acetonitrile \ 1V}$'
